...
import { AppBar, Container, Toolbar, Typography,Button, Box, TextField, Grid} from "@mui/material";
  ...
  return (
   <Container maxWidth="100vh">
    ...
    <AppBar position="static">
      <Toolbar>
        <Typography varient="h6" style={{flexGrow:1}}>Flashcard SaaS</Typography>
        <SignedOut>
